...
export default function Women() {
 ...
 const navigation: any = useNavigation();
  ...
  const womenProducts = all_product.filter((product) => product.category === "women").slice(0, 3);
  ...
  return (
    ...
    >
      <HStack w={"full"} alignItems={"center"}  justifyContent={'space-between'} my={4}>
        ...
        >
          <Text style={{ color: "#FFD700" }}>W</Text>omen
        </Text>
        <Pressable px={4} py={2}rounded={4} bgColor={'#F9D77E'} onPress={() => navigation.navigate("page two", { screen: "women" })} >
